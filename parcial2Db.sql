create database MS101720

use MS101720

--Scaffold-DbContext "Server=CC5-45\SQLEXPRESS;Database=MS101720;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models

create table [elecciones_2019](departamento nvarchar(50),
candidato nvarchar(60), votos int)
